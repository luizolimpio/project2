...
def orders_filters_inline(request, template_name="manage/order/orders_filters_inline.html"):
    ...
    paginatortotal = Paginator(orders, 99999999999999999999999999999999999999999)
    pagetotal = paginatortotal.page(1)
    ...
    orders_total = 0
    for total_order in pagetotal.object_list:
        orders_total += float(total_order.price)
