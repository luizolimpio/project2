...
urlpatterns += patterns('lfs.manage.views.marketing',
    ...
    url(r'^banner$', "featured.banner_view", name="lfs_banner_view"),
    url(r'^banner/update/(\d+)/$', "featured.banner_view_update", name="lfs_banner_view_update"),
    url(r'^banner/delete/(\d+)/$', "featured.banner_view_delete", name="lfs_banner_view_delete"),
    url(r'^relacebusca$', "featured.replacebusca", name="lfs_replacebusca_view"),
    url(r'^replacebusca/update/(\d+)/$', "featured.replacebusca_view_update", name="lfs_replacebusca_view_update"),
    url(r'^replacebusca/delete/(\d+)/$', "featured.replacebusca_view_delete", name="lfs_replacebusca_view_delete"),
)
...
urlpatterns += patterns('lfs.manage.product.images',
    ...
    url(r'^product-images/(?P<product_id>\d*)$', "list_images", name="lfs_manage_images"),
...
urlpatterns += patterns('lfs.manage.product.attachments',
    ...
    url(r'^product-attachments/(?P<product_id>\d*)$', "list_attachments", name="lfs_manage_attachments"),
...
urlpatterns += patterns('lfs.manage.images.views',
    ...
    url(r'^global-images-list$', "images_list", name="lfs_manage_global_images_list"),
