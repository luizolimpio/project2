...
class Customer(models.Model):
    ...
    selected_dinheiro_troco = models.ForeignKey("DinheiroTroco", verbose_name=_(u"Dinheiro Troco"), blank=True, null=True,related_name="selected_dinheiro_troco")
...
class DinheiroTroco(models.Model):
    """
    Stores all shop relevant data of a credit card.
    ...
    **Attributes:**
    ...
    expiration_date_year
        The year of the expiration date of the credit card.
    """
    customer = models.ForeignKey(Customer, verbose_name=_(u"Customer"), blank=True, null=True, related_name="dinheiro_troco")

    Troco = models.CharField(_(u"Troco"), blank=True, null=True, max_length=255)

    def __unicode__(self):
        return u"%s" % (self.Troco)
