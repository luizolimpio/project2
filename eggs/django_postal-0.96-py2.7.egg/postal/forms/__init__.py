...
class PostalAddressForm(forms.Form):
    ...
    code = forms.CharField(label=POSTAL_ADDRESS_CODE[0], required=POSTAL_ADDRESS_CODE[1], max_length=8)
    ...
    def clean_code(self):
        cep = self.cleaned_data["code"]
        if cep[0:5] != "49300" and cep[0:5] != "48475":
            self._errors["code"] = ErrorList(["Entregamos apenas para 49300000 e 48475000"])
        return cep
